...
while True:
    ...
    for blinks in range(5):
        blink(CYAN, 0.5)  # Increase number to slow down blinking, decrease to speed up.

    for blinks in range(5):
        blink(BLUE, 0.5)  # Increase number to slow down blinking, decrease to speed up.

    for blinks in range(5):
        blink(YELLOW, 0.5)  # Increase number to slow down blinking, decrease to speed up.

    for blinks in range(5):
        blink(GREEN, 0.5)  # Increase number to slow down blinking, decrease to speed up.

    for blinks in range(5):
        blink(PURPLE, 0.5)  # Increase number to slow down blinking, decrease to speed up.
